<?php
  ...
  //check if the person voted for is in the db
    ...
    if ($num0 < 1) {
        ...
        header('location: vote_organizer.php');
    }


     $q="SELECT email FROM orgnizer_votes WHERE email='$email' ";
    $result = $conn->query($q);
    ...
    if($num > 0){
       echo"<script>alert('You Have Already Voted.....Thanks')</script>";
        ...
        $q1 = "INSERT INTO orgnizer_votes(fullname,email,department,year_level,voted_for) values ('$fullname','$email','$department','$year_level','$voted_for')";
...
<div class="container" style="height: 100%; margin-top:30px;">
 ...
 <div class="d-sm-flex align-items-center justify-content-between mb-4">
     <h1 class="h3 mb-0 text-gray-800" style="text-align: center;margin-top: 30px;color: #fff;"><b>Vote <?=$fetchQuery['firstname']?> <?=$fetchQuery['lastname']?> For Organizer</b></h1>
 </div>
 <div class="card shadow mb-4 animate__animated animate__fadeInRight" style="margin-top:30px;">
     <div class="card-body">
         <form action="vote_organizer.php" method="post">
             <div class="form-row">
