<?php
  ...
  $fetchQuery = mysqli_fetch_assoc($connectQuery);
    ...
    if ($num0 < 1) {
     ...
     $q="SELECT email FROM pusag_votes WHERE email='$email' ";
    $result = $conn->query($q);
    ...
    if($num > 0){
       ...
       $q1 = "INSERT INTO pusag_votes(fullname,email,department,year_level,voted_for) values ('$fullname','$email','$department','$year_level','$voted_for')";
