...
<body>
  <div class="container"><br><br><br>
    ...
    <div class="row">
      <?php 
        $query1="SELECT firstname, lastname, candImg, candidateID FROM candidates_vote WHERE position = 'SRC President'";
      ...
      <div class="col-md-4">
          <div class="card">
            ...
            <div class="container"><br>
              ...
              <a href="vote1.php?d=<?=$fetchQuery['candidateID']?>" ><span ><button style="margin-top: 20px;" class="slideUpBtn">Vote Now</button></span></a><br> 
            </div>
          </div>
      </div>
    <?php } ?>
