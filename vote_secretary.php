<?php
  ...
  $fetchQuery = mysqli_fetch_assoc($connectQuery);
    ...
    if ($num0 < 1) {
     ...
     $q="SELECT email FROM secretary_votes WHERE email='$email' ";
    $result = $conn->query($q);
    ...
    if($num > 0){
       ...
       $q1 = "INSERT INTO secretary_votes(fullname,email,department,year_level,voted_for) values ('$fullname','$email','$department','$year_level','$voted_for')";
...
<div class="container" style="height: 100%; margin-top:30px;">
 ...
 <div class="d-sm-flex align-items-center justify-content-between mb-4">
     <h1 class="h3 mb-0 text-gray-800" style="text-align: center;margin-top: 30px;color: #fff;"><b>Vote <?=$fetchQuery['firstname']?> <?=$fetchQuery['lastname']?> As Pusag President</b></h1>
 </div>
