...
<body>
  <div class="container"><br><br><br>
    <h2 style="text-align:center;"><b>ORGANIZER CANDIDATE...</b></h2>
    <div class="row">
      <?php 
        $query1="SELECT firstname, lastname, candImg, candidateID FROM candidates_vote WHERE position = 'organizer'";
      ...
      <div class="col-md-4">
          <div class="card">
            ...
            <div class="container"><br>
              ...
              <p style="text-align:center;color: #e0501b;">Vote As Organizer</p>
              <a href="vote_organizer.php?d=<?=$fetchQuery['candidateID']?>" ><span ><button style="margin-top: 20px;" class="slideUpBtn">Vote Now</button></span></a><br> 
            </div>
          </div>
      </div>
    <?php } ?>
